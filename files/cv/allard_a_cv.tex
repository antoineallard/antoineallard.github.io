...
%
\begin{itemize}\small
  % \item Doctoral Training Scholarships, \textit{ Fonds de recherche du Québec: Nature et technologies}, 2023--2024
...
\begin{itemize}[leftmargin=1.5em]\small
  ...
  \item Over 3.2k subscribers as of Aug.~2023
\end{itemize}
%
...
%
  ...
  \item \parbox[t]{\textwidth-30pt}{\textit{Indistinguishability of simple and complex contagion under uncertain transmission settings}\split
  \uline{G.~St-Onge}, L.~Hébert-Dufresne and \textbf{A.~Allard}\split
  \textit{Under consideration at PNAS (second round of reviews; manuscript 2023-12202)}
...
%
  ...
  \textit{Under consideration at Nature Communications (second round of reviews; manuscript NCOMMS-23-10333)}\split
...
%
  ...
  \textit{Under consideration at Scientific Reports (second round of reviews; manuscript 991ffd54-8c0d-4449-a55b-9e6270c6fdfc)}\split
...
%
  ...
  % \textit{Under consideration at Nature Communications (second round of reviews; manuscript NCOMMS-23-15745)}\split
  \href{https://arxiv.org/abs/2304.06580}{Nat. Commun. (in press)}}
%
  % CloSIR
  ...
  % \textit{Under consideration at BMC Global and Public Health (first round of reviews; manuscript 43027003-349f-4dde-9e11-ef0c55858c93)}\split
  \href{https://doi.org/10.1101/2020.08.21.20179473}{BMC Global Public Health (in press)}}
%
  % Francis maîtrise
  ...
  % \textit{Under consideration at Network Neuroscience (second round of reviews; manuscript NETNEURO-23-0013)}\split
  \href{https://doi.org/10.1101/2022.08.29.505749}{Netw. Neurosci. (in press)}}
%
  % Low rank
  ...
  \href{https://arxiv.org/abs/2208.04848}{Nat. Phys. (in press)}}
%
  % Guillemette
...
%
  \item \parbox[t]{\textwidth-30pt}{\textit{A Probabilistic Methodology to Reconstruct Biodiversity from Interactions with Indicator Species Along Latitudinal Co-Occurrence Networks},
  \uline{Ilhem Bouderbala}\split
  Sentinelle Nord Scientific Meeting\split
  Québec, Canada, 2023}
%
  \item \parbox[t]{\textwidth-30pt}{\textit{La géométrie au coeur des systèmes nordiques},
  \uline{Simon Lizotte}\split
  Sentinelle Nord Scientific Meeting\split
  Québec, Canada, 2023}
%
  \item \parbox[t]{\textwidth-30pt}{\textit{On the reconstructability of complex networks} (poster),
...
%
  \item \parbox[t]{\textwidth-30pt}{\textit{On the effectiveness of reconstructing biodiversity from indicator species along a climate gradient} (poster),
  \uline{Ilhem Bouderbala}\split
  Sentinelle Nord Scientific Meeting\split
  Québec, Canada, 2022}
%
