...
\begin{itemize}[leftmargin=1.5em]\small
  ...
  \item New publications are publicly available to the community via %
        ...
        feeds
  \item Over 3k subscribers as of Apr. 2023
\end{itemize}
%
...
%
  ...
  \textit{Under consideration at Nature Communications (first round of reviews; manuscript NCOMMS-23-15745)}\split
...
%
  ...
  \textit{Under consideration at Nature Physics (first round of reviews; manuscript NPHYS-2023-03-00849)}\split
...
%
  ...
  \textit{Under consideration at Scientific Reports (first round of reviews; manuscript XXXXXXXXXX)}\split
...
%
  ...
  \item \parbox[t]{\textwidth-30pt}{\textit{Heterogeneous transmission in groups induces local complex contagions with superlinear infection rates}\split
  \uline{G.~St-Onge}, L.~Hébert-Dufresne and \textbf{A.~Allard}\split
  \textit{Under consideration at Nature Communications (submitted; manuscript NCOMMS-23-17898)}
...
%
  ...
  \href{https://arxiv.org/abs/2206.11230}{PNAS Nexus (in press)}}
%
  % Béatrice Maîtrise
  ...
  \href{https://arxiv.org/abs/2209.09201}{PNAS Nexus (in press)}}
%
  % Ilhem1
  ...
  \href{https://doi.org/10.1111/ddi.13697}{Divers. Distrib. (2023)}}
%
  % Ilhem2
