...
\begin{itemize}[leftmargin=1.5em]\small
  ...
  \item[$\circ$] PHY-3500 Computational Physics \hfill 2020, 2024%
...
% \textsuperscript{,}%
% \footnotetext{Student's thesis added to the Board of Honor, the highest distinction at Université Laval, denoted by $\dagger$.}%
}%
% =================================================================================================
%
...
%
  ...
  \uline{G.~St-Onge}, L.~Hébert-Dufresne and \textbf{A.~Allard}
...
%
  ...
  % \textit{Under review at Physcial Review E}\split
...
%
  ...
  \textit{Under review at Network Neuroscience (manuscript NETNEURO-23-0013)}\split
...
%
  ...
  \textit{Under review at PNAS Nexus (second round; manuscript PNASNEXUS-2022-01001)}\split
...
%
  ...
  \textit{Under review at Science Advances (manuscript adh2654)}\split
...
%
  ...
  \textit{Under review at Communications Physics (second round; manuscript COMMSPHYS-22-0945)}\split
...
%
  ...
  \textit{Under review at Nature Physics (second round; manuscript NPHYS-2022-10-02742)}\split
...
%
  ...
  \textit{Under review at PNAS Nexus (second round; manuscript PNASNEXUS-2022-01018)}\split
...
%
  ...
  \textit{Under review at Journal of Physics:~Complexity (second round; manuscript JPCOMPX-100419)}\split
  \href{https://arxiv.org/abs/2203.00745}{arXiv:2203.00745}}
%
  % Ilhem1
  \item \parbox[t]{\textwidth-30pt}{\textit{Effects of global change on animal biodiversity in boreal forest landscape: an assemblage dissimilarity analysis}\split
  \uline{I.~Bouderbala}, G.~Labadie, J.-M.~Leblanc, Y.~Boulanger, C.~Hébert, P.~Desrosiers, \textbf{A.~Allard} and D.~Fortin\split
  \textit{Under review at Diversity and Distributions (second round; manuscript DDI-2022-0331)}\split
...
%
  ...
  \textit{Under review at Journal of Mathematical Biology (manuscript JOMB-D-23-00079)}\split
...
%
  ...
  \textit{Under review at Nature Communications (manuscript NCOMMS-23-07754)}\split
...
%
  ...
  \textit{Under review at Nature (second round; manuscript 2020-10-19457)}\split
...
%
  ...
  \href{https://doi.org/10.1101/2022.08.21.504664}{PLOS Climate (in press)}}
%
  % Beyond R0 2
