...
\begin{itemize}
  ...
  \item Sentinel North Research Project, \textit{Canada First Research Excellence Fund}, 2020--2023 (750k CAD)
\end{itemize}
%
%
%
...
% =================================================================================================
%
\parbox{\textwidth}{\textbf{International School and Conference on Network Science} (\href{https://netscisociety.net/events/netsci}{NetSci 2024})\hfill Qu\'ebec, Canada\\
...
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Advanced Field School in Computational Ecology} (\href{https://sentinellenord.ulaval.ca/en/ecology2023}{Ecology2023})\hfill Qu\'ebec, Canada\\
Co-organizer\hfill May 2023
\begin{itemize}[leftmargin=1.5em]\small
  \item[$\circ$] Organized by \href{http://sentinellenord.ulaval.ca/}{Sentinelle Nord}
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Complex Networks Winter Workshop} (\href{https://sentinellenord.ulaval.ca/en/formation/ecoles-doctorales-internationales/ecole-internationale-sur-les-reseaux-complexes}{CNWW 2020})\hfill Qu\'ebec, Canada\\
...
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Complex Networks Winter Workshop} (\href{https://sentinellenord.ulaval.ca/en/cnww-2019}{CNWW 2019})\hfill Qu\'ebec, Canada\\
...
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Complex Networks Winter Workshop} (\href{https://sentinellenord.ulaval.ca/en/complex-networks-workshop-2018}{CNWW 2018})\hfill Qu\'ebec, Canada\\
...
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Contagion \& Networks} (\href{http://networkscontagion.github.io/}{ContNet 2018})\hfill Paris, France\\
...
\end{itemize}}
%
\parbox{\textwidth}{\textbf{Contagion \& Networks} (\href{http://networkscontagion.github.io/contnet2017/}{ContNet 2017})\hfill Indianapolis IN, USA\\
...
\begin{itemize}\small
  ...
  \item New publications are publicly available to the community via %
        ...
        feeds
  \item More than 2.5k subscribers
\end{itemize}
%
...
\textsuperscript{,}%
\footnote{\label{foot:equal}Equal contributions are denoted by \textsuperscript{*}.}
%
\begin{etaremune}[itemsep=0.5em, label={[P\reversearabic*]}]\small\vspace{0.5\baselineskip}
% \begin{itemize}[itemsep=0.5em]\small
%
  % Papier JG et Alice
  \item \textit{Exact and rapid linear clustering of networks with dynamic programming}\split
...
%
  % Guillaume ALIFE
  \item \textit{Localization, bistability and optimal seeding of contagions on higher-order networks}\split
...
%
  % Social Zombie
  \item \textit{The Social Zombie: Modeling undead outbreaks on social networks}\split
  L.~H\'ebert-Dufresne, P.-A.~No\"el, V.~Marceau, \textbf{A.~Allard} and L.~J.~Dub\'e\split
...
%
  % Séminaire UBICS
  \item \textit{Dynamics on networks through the lens of spectral and information theories}\split
  Universitat de Barcelona Institute of Complex Systems\split
  Barcelona, Spain, 2022
%
  % Journée Poisson du 1er avril
  \item \textit{Graphe poissonnien, un oxymore?}\split
  Centre Interdisciplinaire en Modélisation Mathématique de l'Université Laval (CIMMUL)\split
  Québec, Canada, 2022
%
  % Séminaire McGill QLS
  \item \textit{Contact Network Epidemiology: Heterogeneity and Stochasticity of Disease Spread}\split
  Quantitative Life Sciences, McGill University\split
  Montréal, Canada, 2022
%
  % Séminaire UVM
  \item \textit{Deep learning of dynamical epidemic processes on complex networks}\split
...
%
  ...
  \item \textit{Chaire de recherche Sentinelle Nord en modélisation mathématique des systèmes et des réseaux complexes}\split
  Official inauguration of the latest Sentinelle Nord research chairs\split
  L\'evis, Canada, 2019
%
  % Présentation à retraite CT1
  \item \textit{An introduction to the methodologies for studying complex networks}\split
...
%
  ...
  \item \textit{Three tales about percolation on real complex networks}\split
  International Conference on Complex Networks (CompleNet 2019)\split
  Tarragona, Spain, 2019
%
  % Présentation à CNWW18 avec Laurent
  \item \textit{Modeling with Random Networks}\split
  Complex Networks Winter Workshop (CNWW18)\split
  Qu\'ebec, Canada, 2018
%
  % Séminaire au CERVO
  \item \textit{Les réseaux complexes: un paradigme unificateur et transformateur pour comprendre la relation dynamique/structure des systèmes complexes}\split
...
%
  % SN 2018
  \item \textit{The hyperbolic brain: A geometric approach to network neuroscience}\split
  Sentinelle Nord Annual Meeting\split
  Qu\'ebec, Canada, 2018
%
  % NetSI
  \item \textit{Towards an effective structure of complex networks and its contributions to epidemiology and neuroscience}\split
  Network Science Institute\split
  Boston, Massachusetts, USA, 2017
%
  % SFI
  \item \textit{Exploring the hidden metric space of complex networks}\split
...
%
  \item \textit{The Low-Rank Hypothesis of Complex Systems: From Empirical and Theoretical Evidence to the Emergence of Higher-Order Interactions},
  \uline{Vincent Thibeault}\split
  SIAM Conference on Applications of Dynamical Systems (DS23)\split
  Portland OR, USA, 2023
%
  \item \textit{Dimension matters when modeling network communities in hyperbolic spaces},
  \uline{Béatrice Désy}\split
  International School and Conference on Network Science (Netsci2022)\split
  Shanghai, China, 2022
%
  \item \textit{Random graph models with fixed centrality patterns and degree sequence},
  \uline{François Thibault}\split
  International School and Conference on Network Science (Netsci2022)\split
  Shanghai, China, 2022
%
  \item \textit{On the importance of correlation in graph reconstruction},
  \uline{SImon Lizotte}\split
  International School and Conference on Network Science (Netsci2022)\split
  Shanghai, China, 2022
%
  \item \textit{Nonlinear infection rate to compress mechanistic epidemic models},
  \uline{Guillaume St-Onge}\split
  Northeast Regional Conference on Complex Systems (NERCCS 2022)\split
  Buffalo NY, USA, 2022
%
  \item \textit{The low-dimension hypothesis implies higher-order interactions in complex systems},
  \uline{Vincent Thibeault}\split
  Northeast Regional Conference on Complex Systems (NERCCS 2022)\split
  Buffalo NY, USA, 2022
%
  \item \textit{Dimension reduction on heterogeneous networks},
  \uline{Marina Vegué Llorente}\split
  Networks 2021: A Joint Sunbelt and NetSci Conference\split
  Washington DC, USA, 2021
%
  \item \textit{Information Theory of Dynamics on Networks: Between Predictability and Reconstructability},
  \uline{Charles Murphy}\split
  Networks 2021: A Joint Sunbelt and NetSci Conference\split
  Washington DC, USA, 2021
%
  \item \textit{Universal nonlinear infection kernel from heterogeneous exposure on higher-order networks},
  \uline{Guillaume St-Onge}\split
  Networks 2021: A Joint Sunbelt and NetSci Conference\split
  Washington DC, USA, 2021
%
  \item \textit{Dimension reduction of high-dimensional dynamics on networks with adaptation},
  \uline{Vincent Thibeault}\split
  Networks 2021: A Joint Sunbelt and NetSci Conference\split
  Washington DC, USA, 2021
%
  \item \textit{Firing rate distributions in plastic networks of spiking neurons},
  \uline{Marina Vegué Llorente}\split
  Networks 2021: A Joint Sunbelt and NetSci Conference\split
  Washington DC, USA, 2021
%
  \item \textit{Information Theory of Dynamics on Networks: Quantifying the Structure-Function Relationship},
  \uline{Charles Murphy}\split
  SIAM Conference on Applications of Dynamical Systems (DS21)
%
  \item \textit{Bursty Exposure on Higher-Order Networks Leads to Nonlinear Infection Kernels},
  \uline{Guillaume St-Onge}\split
  SIAM Conference on Applications of Dynamical Systems (DS21)
%
  \item \textit{Dimension Reduction of High-Dimensional Dynamics on Networks with Adaptation},
...
%
  ...
  Northeast Regional Conference on Complex Systems (NERCCS 2021)
%
  \item \textit{Deep learning of stochastic contagion dynamics on complex networks},
  \uline{Charles Murphy}\split
  International School and Conference on Network Science (Netsci 2020)\split
  Rome, Italy (2020)
%
  \item \textit{Localization, bistability and optimal seeding of contagions on higher-order networks},
  \uline{Guillaume St-Onge}\split
  Conference on Artificial Life (ALIFE 2020)\split
  Montréal, Canada (2020)
%
  \item \textit{Learning dynamical processes on complex networks from time series},
  \uline{Charles Murphy}\split
