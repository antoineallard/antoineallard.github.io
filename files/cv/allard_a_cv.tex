...
%
  % kooku
  \item \parbox[t]{\textwidth-30pt}{\textit{Kuramoto meets Koopman: Integrals of motion, symmetries, and network motifs}\split
  \uline{V.~Thibeault}, \uline{B.~Claveau}, \textbf{A.~Allard} and P.~Desrosiers}
%
  % Geometric-networks
